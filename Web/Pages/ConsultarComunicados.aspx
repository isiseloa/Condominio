<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true"
    CodeBehind="ConsultarComunicados.aspx.cs" Inherits="Web.Pages.ConsultarComunicados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <uc1:PainelMensagem ID="pnlMensagem" runat="server" Titulo="Pesquisar Comunicados" />
    <div id="principal" class="conteudoPrincipal">
        ...
        <asp:GridView Width="1000px" ID="grdComunicados" AutoGenerateColumns="False" 
        ...
        <asp:HyperLink ID="linkCadastro" runat="server" 
            NavigateUrl="~/Pages/CadastrarComunicado.aspx">Cadastrar Novo Comunicado</asp:HyperLink>
    </div>
