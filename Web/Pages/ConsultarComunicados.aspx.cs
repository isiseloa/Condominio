...
namespace Web.Pages
{
    public partial class ConsultarComunicados : PageBase
    {
        /// <summary>
        /// evento diaparado pelo load da pagina
        /// </summary>
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    //consulta os comunicados
                    var lista = Comunicado.ObterComunicados(dataInicial, dataFinal);
                    //se a lista contém registros, atribui na grid
                    if (lista != null && lista.Count > 0)
                    {
                        grdComunicados.DataSource = lista;
                        grdComunicados.DataBind();
